...
export default tseslint.config(
	...
	{
		files: ["packages/goal-x/**/*.ts", "packages/todo/extensions/**/*.ts", "packages/context-window/extensions/**/*.ts"],
	...
	{
		files: ["packages/goal-x/extensions/**/*.ts"],
		rules: {
			"@typescript-eslint/no-explicit-any": "error",
		},
	},
	{
		files: ["packages/goal-x/tests/**/*.mjs"],
